...
class DetalhesDView extends StatefulWidget {
  const DetalhesDView({super.key});

  @override
  State<DetalhesDView> createState() => _DetalhesDViewState();
}

class _DetalhesDViewState extends State<DetalhesDView> {
  ...
  Widget build(BuildContext context) {
    ...
    // ( *^-^)ρ(^0^* )
    //
    final MenuPizzaDoce dados =
        ModalRoute.of(context)!.settings.arguments as MenuPizzaDoce;
    return Scaffold(
      appBar: AppBar(
